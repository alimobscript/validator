define("aliscript/validator/1.0.0/validator-debug", [ "./core-debug", "$-debug", "./async-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "./utils-debug", "./rule-debug", "./item-debug" ], function(require, exports, module) {
    var Core = require("./core-debug"), $ = require("$-debug");
    var Validator = Core.extend({
        events: {},
        attrs: {
            explainClass: "ali-field-message",
            itemClass: "ali-field",
            //itemHoverClass: 'ui-form-item-hover',
            //itemFocusClass: 'ui-form-item-focus',
            itemErrorClass: "ali-field-error",
            itemSuccessClass: "ali-field-success",
            //inputClass: 'ali-field-input',
...
define("aliscript/validator/1.0.0/core-debug", [ "$-debug", "aliscript/validator/1.0.0/async-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "aliscript/validator/1.0.0/utils-debug", "aliscript/validator/1.0.0/rule-debug", "aliscript/validator/1.0.0/item-debug" ], function(require, exports, module) {
    var $ = require("$-debug"), async = require("aliscript/validator/1.0.0/async-debug"), Widget = require("arale/widget/1.1.1/widget-debug"), utils = require("aliscript/validator/1.0.0/utils-debug"), Item = require("aliscript/validator/1.0.0/item-debug");
    var validators = [];
    var setterConfig = {
        value: $.noop,
        setter: function(val) {
    ...
    var Core = Widget.extend({
        ...
        Statics: $.extend({
            helper: utils.helper
        }, require("aliscript/validator/1.0.0/rule-debug"), {
...
define("aliscript/validator/1.0.0/async-debug", [], function(require, exports, module) {
    var async = {};
...
define("aliscript/validator/1.0.0/utils-debug", [ "$-debug", "aliscript/validator/1.0.0/rule-debug" ], function(require, exports, module) {
    var $ = require("$-debug"), Rule = require("aliscript/validator/1.0.0/rule-debug");
    var u_count = 0;
    var helpers = {};
    function unique() {
...
define("aliscript/validator/1.0.0/rule-debug", [ "$-debug" ], function(require, exports, module) {
...
define("aliscript/validator/1.0.0/item-debug", [ "$-debug", "aliscript/validator/1.0.0/utils-debug", "aliscript/validator/1.0.0/rule-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "aliscript/validator/1.0.0/async-debug" ], function(require, exports, module) {
    var $ = require("$-debug"), utils = require("aliscript/validator/1.0.0/utils-debug"), Widget = require("arale/widget/1.1.1/widget-debug"), async = require("aliscript/validator/1.0.0/async-debug"), Rule = require("aliscript/validator/1.0.0/rule-debug");
    var setterConfig = {
        value: $.noop,
        setter: function(val) {
            return $.isFunction(val) ? val : utils.helper(val);
